...
namespace Xenoh.Infrastructure.Migrations
{
    ...
    [Migration("20260911052623_AddProgressLibrary")]
    partial class AddProgressLibrary
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Xenoh.Domain.Entities.LegalAcceptance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UserId", "DocumentType", "AcceptedAt");
            ...
            modelBuilder.Entity("Xenoh.Domain.Entities.ProgressCheckIn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsSharedWithCoach")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("OwnerId", "CheckInDate");

                    b.HasIndex("OwnerId", "IsSharedWithCoach");

                    b.ToTable("ProgressCheckIns");
                });

            modelBuilder.Entity("Xenoh.Domain.Entities.ProgressPhoto", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("ProgressCheckInId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProgressCheckInId", "SortOrder");
            ...
            modelBuilder.Entity("Xenoh.Domain.Entities.SupplementDoseSlot", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ScheduleVersionId", "Time");

                    b.ToTable("SupplementDoseSlots");
                });

            modelBuilder.Entity("Xenoh.Domain.Entities.SupplementIntakeLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DoseSlotId", "ScheduledDate")
                        .IsUnique();

                    b.HasIndex("UserId", "ScheduledDate");

                    b.ToTable("SupplementIntakeLogs");
                });

            modelBuilder.Entity("Xenoh.Domain.Entities.SupplementRegimen", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("SupplementRegimens");
                });

            modelBuilder.Entity("Xenoh.Domain.Entities.SupplementScheduleVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RegimenId", "EffectiveFrom", "EffectiveTo");

                    b.ToTable("SupplementScheduleVersions");
                });
            ...
            modelBuilder.Entity("Xenoh.Domain.Entities.LegalAcceptance", b =>
                {
                    b.HasOne("Xenoh.Domain.Entities.PaymentOrder", null)
                        .WithOne()
                        .HasForeignKey("Xenoh.Domain.Entities.LegalAcceptance", "PaymentOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Xenoh.Domain.Entities.ProgressPhoto", b =>
                {
                    b.HasOne("Xenoh.Domain.Entities.ProgressCheckIn", "ProgressCheckIn")
                        .WithMany("Photos")
                        .HasForeignKey("ProgressCheckInId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProgressCheckIn");
                });
            ...
            modelBuilder.Entity("Xenoh.Domain.Entities.SupplementDoseSlot", b =>
                {
                    b.HasOne("Xenoh.Domain.Entities.SupplementScheduleVersion", "ScheduleVersion")
                        .WithMany("DoseSlots")
            ...
            modelBuilder.Entity("Xenoh.Domain.Entities.SupplementIntakeLog", b =>
                {
                    b.HasOne("Xenoh.Domain.Entities.SupplementDoseSlot", "DoseSlot")
                        .WithMany("IntakeLogs")
                        .HasForeignKey("DoseSlotId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Xenoh.Domain.Entities.ApplicationUser", "User")
                        .WithMany("SupplementIntakeLogs")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("DoseSlot");
            ...
            modelBuilder.Entity("Xenoh.Domain.Entities.SupplementRegimen", b =>
                {
                    b.HasOne("Xenoh.Domain.Entities.ApplicationUser", "CreatedByUser")
                        .WithMany("CreatedSupplementRegimens")
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Xenoh.Domain.Entities.ApplicationUser", "User")
                        .WithMany("SupplementRegimens")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Xenoh.Domain.Entities.SupplementScheduleVersion", b =>
                {
                    b.HasOne("Xenoh.Domain.Entities.ApplicationUser", "CreatedByUser")
                        .WithMany("CreatedSupplementScheduleVersions")
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Xenoh.Domain.Entities.SupplementRegimen", "Regimen")
            ...
            modelBuilder.Entity("Xenoh.Domain.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Navigation("CreatedSupplementRegimens");

                    b.Navigation("CreatedSupplementScheduleVersions");
                    ...
                    b.Navigation("SupplementIntakeLogs");

                    b.Navigation("SupplementRegimens");
