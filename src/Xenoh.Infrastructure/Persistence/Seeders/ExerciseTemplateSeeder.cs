...
public static class ExerciseTemplateSeeder
{
    ...
    [
        ...
        // ── CARDIO ─────────────────────────────────────────────────────────────
        new() { Name = "Running",                  Description = "Treadmill or outdoor running",                 PrimaryMuscleGroup = MuscleGroup.Cardio,     SecondaryMuscleGroups = [MuscleGroup.Quads, MuscleGroup.Calves, MuscleGroup.Glutes] },
        new() { Name = "Cycling",                  Description = "Stationary bike or outdoor cycling",          PrimaryMuscleGroup = MuscleGroup.Cardio,     SecondaryMuscleGroups = [MuscleGroup.Quads, MuscleGroup.Glutes, MuscleGroup.Calves] },
        new() { Name = "Rowing Machine",           Description = "Ergometer rowing machine",                    PrimaryMuscleGroup = MuscleGroup.Cardio,     SecondaryMuscleGroups = [MuscleGroup.Back, MuscleGroup.Shoulders, MuscleGroup.Quads] },
        new() { Name = "Jump Rope",                Description = "Skipping rope cardio",                        PrimaryMuscleGroup = MuscleGroup.Cardio,     SecondaryMuscleGroups = [MuscleGroup.Calves, MuscleGroup.Shoulders] },
        new() { Name = "Assault Bike",             Description = "Fan bike full-body cardio",                   PrimaryMuscleGroup = MuscleGroup.Cardio,     SecondaryMuscleGroups = [MuscleGroup.Shoulders, MuscleGroup.Quads] },
        new() { Name = "Elliptical",               Description = "Elliptical cross-trainer",                    PrimaryMuscleGroup = MuscleGroup.Cardio,     SecondaryMuscleGroups = [MuscleGroup.Quads, MuscleGroup.Glutes] },
        new() { Name = "Stair Climber",            Description = "Stair climber machine",                       PrimaryMuscleGroup = MuscleGroup.Cardio,     SecondaryMuscleGroups = [MuscleGroup.Glutes, MuscleGroup.Quads, MuscleGroup.Calves] },
        new() { Name = "Mountain Climber",         Description = "Bodyweight mountain climber",                 PrimaryMuscleGroup = MuscleGroup.Cardio,     SecondaryMuscleGroups = [MuscleGroup.Abs, MuscleGroup.Shoulders] },
    ];
}
